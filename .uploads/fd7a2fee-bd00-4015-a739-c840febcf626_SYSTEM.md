...
| 写稿会话 | 长期 | 选题、开书策划、章节规划、写正文、更新状态 | `prompts/writer.md` |
...
| check_facts_consistency.py | `python tools/check_facts_consistency.py <小说目录>` | 开书后、每章后跑，扫跨文件数字矛盾 |
...
## 版本记录
- **v5.2 (2026-07-03)**：事件驱动模式——批量提纲+正文分离改为逐章循环，新增story_threads/world_state/story_direction三个追踪文件，事件扫描驱动剧情，热点融入并入逐章循环
